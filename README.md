...
2026-07-17 UTC
([run 29611469776](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776));
the clean online run completed on 2026-07-17 UTC
([run 29611469724](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724)).
...
| --- | --- |
| Online prepared password login | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Signs into a stable fixture, verifies synchronized GitHub and Microsoft codes, verifies a Dropbox code in Trash, and opens Account and Security settings. |
| Online TOTP login | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Signs into a prepared two-factor account, completes its live TOTP challenge, verifies its synchronized GitHub code, and opens Security settings. |
| Online unknown-account login | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Configures the local Auth endpoint and verifies the expected “Email not registered.” error. |
| Online signup and first Auth key | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Creates a unique account with deterministic OTT `123456`, acknowledges its recovery key, adds its first GitHub code, and verifies the Auth key and entity reached Museum. |
| Online password login | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Starts from fresh Auth state, signs into the account created earlier in the run, and verifies its synchronized GitHub code. |
| Online recovery-key password reset | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Resets a fixture account with its recovery key, proves the old password is rejected, signs in with the replacement password from fresh state, and verifies its synchronized Google code remains visible. |
| Online persisted bulk tag edit | [![Passed: run 29611469724](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469724) Selects two synchronized Work codes, applies one tag to both, verifies two Museum mutations, then signs in from fresh state and verifies both codes through that tag. |
| Offline setup and validation | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Covers onboarding, offline mode, the backup warning, GitHub TOTP setup, required-field validation, advanced fields, and HOTP/TOTP selection. |
| Offline lifecycle and organization | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Covers code details/editing, issuer/account search, empty results, sorting, and home-list organization. |
| Offline bulk pin actions | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Uses Select all for a uniform selection, then exercises Pin, Unpin, and mixed-state actions that change only the applicable code. |
| Offline settings | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Covers Settings plus Data, Security, General, Support, About, Theme, and version-label surfaces. |
| Offline duplicate codes | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Creates two identical GitHub accounts and verifies their two-code group in Data → Duplicate codes without deleting data. |
| Offline tags | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Creates a tag and filters the offline code list by it. |
| Offline bulk tag edit | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Selects GitHub and Stripe, applies one new `Finance` tag to both, and verifies both through the tag filter. |
| Offline bulk tag removal | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Removes `Finance` from two selected codes and confirms the tag filter disappears. |
| Offline trash | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Moves one code to Trash, opens Trash, and restores it without permanently deleting it. |
| Offline bulk trash and restore | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Moves GitHub and Stripe to Trash together, proves both are there, then restores both to All. |
| Offline permanent deletion | [![Passed: run 29611469776](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29611469776) Moves GitHub and Stripe to Trash, then permanently deletes both. |
