...
([run 29556312742](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742));
...
| Offline setup and validation | [![Passed: run 29556312742](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742) Covers onboarding, offline mode, the backup warning, GitHub TOTP setup, required-field validation, advanced fields, and HOTP/TOTP selection. |
| Offline lifecycle and organization | [![Passed: run 29556312742](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742) Covers code details/editing, issuer/account search, empty results, sorting, and home-list organization. |
| Offline settings | [![Passed: run 29556312742](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742) Covers Settings plus Data, Security, General, Support, About, Theme, and version-label surfaces. |
| Offline duplicate codes | [![Passed: run 29556312742](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742) Creates two identical GitHub accounts and verifies their two-code group in Data → Duplicate codes without deleting data. |
| Offline tags | [![Passed: run 29556312742](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742) Creates a tag and filters the offline code list by it. |
| Offline trash | [![Passed: run 29556312742](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29556312742) Moves a code to Trash, opens Trash, and restores the code without permanently deleting it. |
