...
([run 29558854231](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231));
...
| Offline setup and validation | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Covers onboarding, offline mode, the backup warning, GitHub TOTP setup, required-field validation, advanced fields, and HOTP/TOTP selection. |
| Offline lifecycle and organization | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Covers code details/editing, issuer/account search, empty results, sorting, and home-list organization. |
| Offline settings | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Covers Settings plus Data, Security, General, Support, About, Theme, and version-label surfaces. |
| Offline duplicate codes | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Creates two identical GitHub accounts and verifies their two-code group in Data → Duplicate codes without deleting data. |
| Offline tags | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Creates a tag and filters the offline code list by it. |
| Offline bulk tag edit | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Selects GitHub and Stripe, applies one new `Finance` tag to both, and verifies both through the tag filter. |
| Offline trash | [![Passed: run 29558854231](https://img.shields.io/badge/Latest%20run-passed-2ea44f?style=flat-square&logo=githubactions&logoColor=white)](https://github.com/neeraj-pilot/ente-maestro-tests/actions/runs/29558854231) Moves a code to Trash, opens Trash, and restores the code without permanently deleting it. |
