    ...
    for changed_file in "${changed_files[@]}"; do
        case "$changed_file" in
            ...
            maestro/auth/online/prepared-basic-login.yaml)
                ...
                add_lane entity-lifecycle
                ;;
            maestro/auth/online/prepared-entity-lifecycle-delete.yaml|maestro/auth/online/prepared-entity-lifecycle-restore.yaml|maestro/auth/online/prepared-entity-lifecycle-start.yaml)
                add_lane entity-lifecycle
                ;;
