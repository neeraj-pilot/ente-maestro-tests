    ...
    for changed_file in "${changed_files[@]}"; do
        case "$changed_file" in
            ...
            maestro/auth/online/prepared-recovery-password-reset.yaml)
                ...
                ;;
            maestro/auth/online/prepared-basic-login.yaml|maestro/auth/online/prepared-bulk-mutation-complete.yaml|maestro/auth/online/prepared-bulk-mutation-start.yaml|maestro/auth/online/prepared-entity-lifecycle-delete.yaml|maestro/auth/online/prepared-entity-lifecycle-restore.yaml|maestro/auth/online/prepared-entity-lifecycle-start.yaml|maestro/auth/online/prepared-password-login.yaml)
                add_lane data-sync
                ;;
